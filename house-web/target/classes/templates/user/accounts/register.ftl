                ...
                <div class="col-md-4 col-sm-6 col-md-offset-4 col-sm-offset-3">
                    ...
                    <form role="form" id="form-create-account" method="post" enctype="multipart/form-data" action="/accounts/register">
                        ...
                        <div class="form-group">
                            ...
                            <figure class="note"><strong>提示:</strong> 你可以一次上傳所有头像!</figure>
                        </div>
                    ...
                    <hr>
                    <div class="center">   <!-- terms-conditions.html-->
                        <figure class="note"> 我已阅读并同意<a href="/xieyi">用户协议</a></figure>
                    </div>
                </div>
            </div><!-- /.row -->
        </div><!-- /.container -->
