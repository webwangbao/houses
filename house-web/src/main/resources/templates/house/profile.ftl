            ...
            <div class="container">
                ...
                <div class="user-area">
                    <div class="actions">
                        ...
                        <a href="create-account.html" class="promoted"><strong>注册</strong></a>
                ...
                <nav class="collapse navbar-collapse bs-navbar-collapse navbar-right" role="navigation">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="has-child"><a href="#">Properties</a>
                            <ul class="child-navigation">
                                <li><a href="property-detail.html">房产详情</a></li>
                        ...
                        <li class="has-child"><a href="#">Agents & Agencies</a>
                            <ul class="child-navigation">
                                ...
                                <li><a href="agent-detail.html">经纪人详情</a></li>
                                <li><a href="agencies-listing.html">经纪机构列表</a></li>
                                <li><a href="agency-detail.html">经纪机构详情</a></li>
                            </ul>
                        </li>
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-3">
                            <article>
                                ...
                                <hr>
                                <a href="#" class="link-arrow">了解更多</a>
                            </article>
                        </div><!-- /.col-sm-3 -->
                        <div class="col-md-3 col-sm-3">
                            <article>
                        ...
                        <div class="col-md-3 col-sm-3">
                            <article>
                                ...
                                +1 (734) 123-4567<br>
                                <a href="#">webwangbao@example.com</a>
                            </article>
                        </div><!-- /.col-sm-3 -->
                        <div class="col-md-3 col-sm-3">
                            <article>
