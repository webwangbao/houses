...
import com.webwangbao.house.biz.service.AgencyService;
import com.webwangbao.house.biz.service.CityService;
import com.webwangbao.house.biz.service.CommentService;
import com.webwangbao.house.biz.service.HouseService;
...
import com.webwangbao.house.common.result.ResultMsg;
...
public class HouseController {
	...
	public String ownlist(House house,Integer pageNum,Integer pageSize,ModelMap modelMap){
		...
		modelMap.put("ps", houseService.queryHouseNew(house, PageParams.build(pageSize, pageNum)));
	 ...
	 * @return
	 */
	@RequestMapping(value="house/up")
	public String upSale(Long id,String pageType){
		User user = UserContext.getUser();
		houseService.upHouse(id,user.getId(),pageType.equals("own")?HouseUserType.SALE:HouseUserType.BOOKMARK);
		return "redirect:/house/ownlist";
	}
