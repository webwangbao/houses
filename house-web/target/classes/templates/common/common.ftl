   ...
   <footer id="page-footer">
        <div class="inner">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <article>
                                <h3>关于我们</h3>
                                <p> 好房网集房源信息搜索、产品研发、大数据处理、服务标准建立为一体的以数据驱动的全价值链房产服务平台，不存在任何假房源和黑中介。好房网的前身为好房在线，成立于2010年并于2014年正式更名为好房网。目前，好房网线上房源已覆盖北京、上海、广州、深圳、天津、成都、青岛、重庆、大连等36个地区。在房产交易服务领域，好房网旨在通过“链接人与服务”不断提高服务效率、提升服务体验，为用户提供更安全、更便捷、更舒心的综合房产服务，致力于实现推动行业进步，让房屋交易不再难的企业愿景。
                                </p>
                                <hr>
                            </article>
                        </div><!-- /.col-sm-3 -->
                        <div class="col-md-3 col-sm-3">
                            <article>
                                ...
                                联系电话:010-87111111<br>
                                <a href="#">联系邮箱:webwangbao@example.com</a>
                            </article>
                        </div><!-- /.col-sm-3 -->
                        <div class="col-md-3 col-sm-3">
                            <article>
            ...
            <aside id="footer-copyright">
                <div class="container">
                    <span>Copyright © 2018. 保留所有权限!.</span>
                    <span class="pull-right"><a href="#page-top" class="roll">置顶</a></span>
                </div>
            </aside>
        </div><!-- /.inner -->
    </footer>
        ...
        <div class="secondary-navigation">
            <div class="container">
                ...
                <div class="user-area">
                    <div class="actions">
                    <#if (loginUser.name)??>
                        <a href="/accounts/profile" class="promoted">你好!欢迎你:${(loginUser.name)!}</a>
            ...
            <header class="navbar" id="top" role="banner">
                ...
                <nav class="collapse navbar-collapse bs-navbar-collapse navbar-right" role="navigation">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="has-child"><a href="/agency/agentList">经纪人</a>
                            <ul class="child-navigation">
